...
class _AddExpensePageState extends State<AddExpensePage> {
  ...
  void _showPercentageDialog() {
    ...
    selectedMembers[0]['percentage'] +=
        (100 - (defaultPercent * selectedMembers.length));

    showDialog(
      context: context,
      builder: (context) {
        return StatefulBuilder(
          // Dùng StatefulBuilder để update UI trong Dialog
          builder: (context, setDialogState) {
            int totalPercent = selectedMembers.fold(
              0,
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    if (totalPercent != 100) {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text("Tổng tỷ lệ phải bằng 100%"),
                        ),
                      );
                    } else {
                      // Lưu và đóng
                      ...
                      Container(
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton<String>(
                            ...
                            items: payers.map<DropdownMenuItem<String>>((
                              String value,
                            ) {
            ...
            Container(
              ...
              child: const TextField(
                ...
                decoration: InputDecoration.collapsed(
                  hintText: "Thêm ghi chú cho khoản chi...",
