...
import 'package:hs/features/bulletin_board/presentation/pages/bulletin_detail_page.dart' show BulletinDetailPage;
...
import 'package:hs/features/profile/presentation/pages/profile_page.dart' show ProfilePage;
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/bulletin_detail': (context) => const BulletinDetailPage(),
